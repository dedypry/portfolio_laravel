            ...
            <div class="row">
                <div class="col-12 text-center mb-2">
                    <ul class="list-inline mb-4" id="portfolio-flters">
                        ...
                        <li class="btn btn-secondary" data-filter=".{{$port->slug}}"><i class="fa {{$port->icon}} me-2"></i>{{$port->title}}
                        </li>
                        @endforeach
                    ...
                    @foreach ($images as $img)
                        <div class="col-md-6 mb-4 portfolio-item {{$app->slug}}">
                            <div class="position-relative overflow-hidden mb-2">
                                <img class="img-fluid w-100" style="height: 150px" src="{{ asset('storage/'.$img) }}"
                                    alt="">
